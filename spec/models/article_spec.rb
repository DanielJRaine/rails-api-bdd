...
RSpec.describe Article do
  ...
  describe 'comments association' do
    ...
    it "validates the presence of an articl's title and content" do
      expect(Article.create(title: 'test', content: 'bloob')).to be_valid
      expect(Article.create(content: 'bloob')).to be_invalid
    end
  end
end
